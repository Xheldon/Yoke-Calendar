...
[⬇️ 下载](../../releases) · macOS / Windows / Linux · 免费

[English](README.md) · **简体中文**

</div>

![Yoke Calendar](assets/light_cn.png)
...
完整使用说明(排期、同步、AI 总结、日历订阅、数据备份、常见问题)见官网的文档页。

---

<sub>本仓库托管 Yoke Calendar 的官网与发布产物;应用源码在另一个私有仓库。</sub>
